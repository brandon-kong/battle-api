    ...
    return (
        <main className="flex place-content-center items-center bg-gradient-to-t from-blue-100 to-blue-50 pt-navbar-2x xl:pt-navbar">
            ...
            >
                ...
                <div
                className={'flex gap-12 xl:gap-8 flex-col md:flex-col-reverse xl:flex-row-reverse w-full place-content-between md:place-items-start'}
                >

                    <div
                    className={'flex flex-col md:flex-row xl:flex-col gap-6 md:gap-12 xl:gap-6 xl:max-w-xl'}
                    >
                        <Typography variant="h1" className={'md:flex-[.5] w-full xl:w-full'}>
                            battle testing your software has never been <span className={'text-blue-600'}>easier.</span>
                        </Typography>

                        <div className={'flex flex-col space-y-6 md:flex-[.5] w-full xl:w-full'}>
                            <Typography variant="p-large" className={''}>
